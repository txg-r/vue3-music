    ...
    <div class="container" :class="sw">
      ...
      <div class="container-form container-signup">
        <form action="" class="form">
          ...
          />
          <button class="submit" @click="register">提交</button>
        </form>
      </div>
      <!-- 登录页面 -->
      ...
      <div class="container-overlay">
        <div class="overlay">
          <div class="overlay-slide overlay-left">
            <button class="submit" id="goSignIn" @click="change">
              sign in
            </button>
          </div>
          <div class="overlay-slide overlay-right">
            <button class="submit" id="goSignUp" @click="change">
              sign up
            </button>
          </div>
        </div>
...
function change() {
  ...
  sw.value = sw.value == "" ? "switch" : "";
}

const login = function () {
  resolveResPromise(userStore.login(), 200, (data: string) => {
...
const register = function () {
  resolveResPromise(userStore.register(), 200, () => {
    setTimeout(() => {
      sw.value = "";
    }, 500);
  });
